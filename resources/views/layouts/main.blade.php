...
<head>
    ...
    <title>SUN OPERATIONAL LIGHT INITIATIVE DEVELOPMENT</title>
            ...
            <div class="rev_slider banner-slider">
                <ul>
                    ...
                    <li data-transition="random" data-slotamount="7" data-masterspeed="500" class="slide-1" >
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('assets/img/slide-banner-01.jpg') }}" alt="banner" data-bgfit="contain" data-bgposition="center 30%" data-bgrepeat="no-repeat">
                        ...
                        <div
                            ...
                            <h2>Welcome To<br>
                                <strong>SUN OPERATIONAL LIGHT INITIATIVE DEVELOPMENT</strong>
                            </h2>
                        </div>
                    ...
                    <li data-transition="random" data-slotamount="7" data-masterspeed="500" class="slide-2" >
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('assets/img/slide-banner-02.jpg') }}" alt="banner" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        ...
                        <div
                            ...
                            <p style="font-size: larger; color: #fff;">
                                A network and solar affiliate and a sole distributor<br>
                                to Kamisafe Solar Energy, Macpower Inverter,<br>
                                Inegy Kodiac and among others
                            </p>
                        </div>
                        <div
                            data-endspeed="1700"
...
<!-- Switcher Style Js -->
<script src="{{ asset('assets/js/style-switcher/assets/js/style.switcher.js') }}"></script>
